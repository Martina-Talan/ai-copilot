    ...
    <div class="row g-0 min-vh-100 d-flex">
      ...
      <div class="col-lg-6 d-flex flex-column justify-content-between bg-light p-5">
        ...
        <div class="text-center d-flex flex-column align-items-center justify-content-center">
          <p class="h3 text-dark mb-4 aiva-testimonial">
            AIVA completely transformed the way my team works with technical documents. It's fast, smart, and reliable.
          </p>
          ...
          <div class="d-flex flex-column align-items-center">
            <img src="/img/user-2.jpg" alt="User photo" class="rounded-circle mb-2 user-photo" />
            <p class="h4 fw-semibold text-dark mb-3 user-name">Daniel Weber</p>
            <p class="h5 text-muted user-data">AI Specialist | NovaLabs</p>
          </div>
        </div>
      ...
      <div class="col-lg-6 d-flex justify-content-center align-items-center bg-white p-5">
        <div class="w-100 form-wrapper">
          <h2 class="display-5 fw-bold text-dark mb-3">Create your account</h2>
          <p class="register-text text-muted mb-5">Start exploring your documents with AI.</p>

          <form @submit.prevent="handleRegister" class="vstack gap-4">
            <input
              v-model="email"
              type="email"
          ...
          <p class="register-text text-center text-muted mt-5 small">
            Already have an account?
            <router-link to="/login" class="text-decoration-none fw-semibold text-custom">
              Sign in
            </router-link>
          </p>
        </div>
