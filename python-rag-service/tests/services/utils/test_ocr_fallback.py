...
# ---------- Inject fake pytesseract ----------

fake_pyt = types.ModuleType("pytesseract")
fake_pyt.image_to_osd = lambda img: "Rotate: 0\n"
fake_pyt.image_to_string = lambda img, lang=None, config=None: "OK"
sys.modules["pytesseract"] = fake_pyt

import app.services.utils.ocr_fallback as ocr_mod

# ---------- Fake PDF Page and Pixmap ----------
...
def test_basic_success(monkeypatch):
    ...
    monkeypatch.setattr(ocr_mod.pytesseract, "image_to_string", lambda img, lang=None, config=None: "Hallo Welt")
...
def test_osd_rotation_applied(monkeypatch):
    ...
    monkeypatch.setattr(ocr_mod.pytesseract, "image_to_string", lambda img, lang=None, config=None: "rotated")
...
def test_resize_when_too_large(monkeypatch):
    ...
    def spy_image_to_string(img, lang=None, config=None):
